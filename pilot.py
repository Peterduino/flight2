...
# The whole code
    ...
    altiDual = 430    # altitude where the dual is ignition
		        ...
		        # Si alti ok et on est dans la zone
                    if True : #nvSecu==1:
                        ...
                        ##### Pilotage et verification zone #####
                            ...
                            positionActuelle = shared_data.get('nvSecu', [None,None,None])[1:2]
                            ...
                            ##### If in zone #####
                                ...
                                positionActuelle = shared_data.get('nvSecu', [None,None,None])[1:2] # recuperer (latitude, longitude)
